...
{
    [BurstCompile]
    public class UnionByBenchmark : IBenchmark
    {
        public string Name => "UnionBy";
        ...
        {
            BenchmarkRunner.Run<UnionByBenchmark>(elementCount, BLinq, BLinqBurst);
        }
