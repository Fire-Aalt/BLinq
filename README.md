...
Comparisons against regular LINQ under Burst have shown query speedups from about **2.5x** to **100x** depending on query shape. 
...
including Unity collections and optional Entities, KrasCore, and BovineLabs.Core collections when those packages are available.
