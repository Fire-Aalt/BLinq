...
namespace FireAlt.BLinq
{
    ...
    public struct IntersectBy<TEnumerator, TOtherEnumerator, T, TKey, TKeySelector> : IEnumerator<T>
        where TEnumerator : unmanaged, IEnumerator<T>
        where TOtherEnumerator : unmanaged, IEnumerator<TKey>
        where T : unmanaged
        where TKey : unmanaged, IEquatable<TKey>
    ...
    public struct IntersectBy<TEnumerator, TOtherEnumerator, T, TKey> : IEnumerator<T>
        where TEnumerator : unmanaged, IEnumerator<T>
        where TOtherEnumerator : unmanaged, IEnumerator<TKey>
        where T : unmanaged
        where TKey : unmanaged, IEquatable<TKey>
