...
namespace FireAlt.BLinq
{
        ...
        where T : unmanaged
    {
        ...
        public T MinBy<TKey, TKeySelector, TKeyComparer>(TKeySelector keySelector, TKeyComparer comparer)
            where TKey : unmanaged
            where TKeySelector : unmanaged, ISelector<T, TKey>
            where TKeyComparer : unmanaged, IComparer<TKey>
        {
            return BLinqUtilities.MinBy<T, TKey, TEnumerator, TKeySelector, TKeyComparer>(
                GetEnumerator(),
                keySelector,
                comparer);
        }
    ...
    public static partial class BLinqExtensions
    {
        ...
        /// <param name="keySelector">Selector used to compute a key for each element.</param>
        /// <returns>The element with the minimum selected key.</returns>
        public static T MinBy<T, TKey, TEnumerator, TKeySelector>(
        ...
        /// <param name="comparer">The comparer used to order keys.</param>
        /// <returns>The element with the minimum selected key.</returns>
        public static T MinBy<T, TKey, TEnumerator, TKeySelector, TKeyComparer>(
            this Query<TEnumerator, T> source,
            TKeySelector keySelector,
            ...
            where TKeyComparer : unmanaged, IComparer<TKey>
        {
            return source.MinBy<TKey, TKeySelector, TKeyComparer>(keySelector, comparer);
        }
        ...
        public static T MinBy<T, TKey, TEnumerator>(
            this Query<TEnumerator, T> source,
        ...
        [NativeDelegateMethod(typeof(ISelector<,>))]
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static T MinBy<T, TKey, TEnumerator, TKeyComparer>(
            this Query<TEnumerator, T> source,
            Func<T, TKey> keySelector,
            TKeyComparer comparer)
            where T : unmanaged
