...
namespace FireAlt.BLinq
{
    ...
    public struct Join<TOuterEnumerator, TInnerEnumerator, TOuter, TInner, TKey, TResult, TOuterKeySelector, TInnerKeySelector, TResultSelector> : IEnumerator<TResult>
        where TOuterEnumerator : unmanaged, IEnumerator<TOuter>
        where TInnerEnumerator : unmanaged, IEnumerator<TInner>
        where TOuter : unmanaged
        where TInner : unmanaged
    ...
    public struct Join<TOuterEnumerator, TInnerEnumerator, TOuter, TInner, TKey, TResult> : IEnumerator<TResult>
        where TOuterEnumerator : unmanaged, IEnumerator<TOuter>
        where TInnerEnumerator : unmanaged, IEnumerator<TInner>
        where TOuter : unmanaged
        where TInner : unmanaged
