...
[assembly: GenerateQueryExtensionFor(typeof(NativeArray<>), typeof(NativeArray<>.Enumerator), LengthProperty = nameof(NativeArray<int>.Length))]
[assembly: GenerateQueryExtensionFor(typeof(NativeArray<>.ReadOnly), typeof(NativeArray<>.ReadOnly.Enumerator), LengthProperty = nameof(NativeArray<int>.ReadOnly.Length))]
[assembly: GenerateQueryExtensionFor(typeof(NativeSlice<>), typeof(NativeSlice<>.Enumerator), LengthProperty = nameof(NativeSlice<int>.Length))]

// Unity.Collections
[assembly: GenerateQueryExtensionFor(typeof(NativeList<>), typeof(NativeArray<>.Enumerator), LengthProperty = nameof(NativeList<int>.Length))]
[assembly: GenerateQueryExtensionFor(typeof(UnsafeList<>), typeof(UnsafeList<>.Enumerator), LengthProperty = nameof(UnsafeList<int>.Length))]
...
#if ENTITIES
[assembly: GenerateQueryExtensionFor(typeof(Unity.Entities.DynamicBuffer<>), typeof(NativeArray<>.Enumerator), LengthProperty = nameof(Unity.Entities.DynamicBuffer<int>.Length))]
#endif

#if FA_CORE
[assembly: GenerateQueryExtensionFor(typeof(KrasCore.UnsafeArray<>), typeof(KrasCore.UnsafeArray<>.Enumerator), LengthProperty = nameof(KrasCore.UnsafeArray<int>.Length))]
...
#if BL_CORE
[assembly: GenerateQueryExtensionFor(typeof(BovineLabs.Core.Collections.UnsafeArray<>), typeof(BovineLabs.Core.Collections.UnsafeArray<>.Enumerator), LengthProperty = nameof(BovineLabs.Core.Collections.UnsafeArray<int>.Length))]
[assembly: GenerateQueryExtensionFor(typeof(BovineLabs.Core.Collections.UnsafeDynamicBuffer<>), typeof(NativeArray<>.Enumerator), LengthProperty = "Length")]
